...
- Provider errors: 0
- False accepts (accepted selection that failed the rule): 12
- False rejects (answerable question not accepted): 2

| Verdict | Count |
|---|---:|
| `correct_refusal` | 7 |
| `expected_source_covered` | 21 |
| `false_refusal` | 2 |
| `false_selection` | 5 |
| `irrelevant_selection` | 5 |
| `partial_source_coverage` | 2 |
...
| HELD-05 | heldout | True | `accepted` | True | `irrelevant_selection` | True | False |
...
| HELD-10 | heldout | True | `accepted` | True | `irrelevant_selection` | True | False |
...
| HELD-13 | heldout | True | `accepted` | True | `expected_source_covered` | True | True |
...
| HELD-22 | heldout | True | `refused` | True | `false_refusal` | None | False |
| HELD-23 | heldout | True | `accepted` | True | `irrelevant_selection` | True | False |
...
| HELD-28 | heldout | True | `accepted` | True | `irrelevant_selection` | True | False |
| HELD-29 | heldout | True | `accepted` | True | `partial_source_coverage` | True | False |
...
| HELD-33 | heldout | False | `accepted` | True | `false_selection` | True | False |
...
| HELD-38 | heldout | False | `accepted` | True | `false_selection` | True | False |
...
| HELD-42 | heldout | False | `refused` | True | `correct_refusal` | None | False |
