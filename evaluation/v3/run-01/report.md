...
|---|---:|
| `correct_refusal` | 9 |
| `expected_source_covered` | 18 |
| `false_refusal` | 3 |
| `false_selection` | 3 |
| `irrelevant_selection` | 8 |
...
| HELD-03 | heldout | True | `accepted` | True | `irrelevant_selection` | True | False |
...
| HELD-06 | heldout | True | `accepted` | True | `irrelevant_selection` | True | False |
...
| HELD-10 | heldout | True | `refused` | True | `false_refusal` | None | False |
...
| HELD-13 | heldout | True | `accepted` | True | `irrelevant_selection` | True | False |
...
| HELD-16 | heldout | True | `accepted` | True | `irrelevant_selection` | True | False |
...
| HELD-37 | heldout | False | `refused` | True | `correct_refusal` | None | False |
